...
{
    public partial class LibroAsistencias : System.Web.UI.Page
    {
        ...
        public string DiasDelMes(int month)
        {
            ...
            string wk = DateOne(today.Year, month+1);
        ...
        protected void btnMostrar_Click(object sender, EventArgs e)
        {
            ...
            Session["Mes" + Session.SessionID] = cbxMes.SelectedIndex;
            Response.Redirect("~/FolderFormularios/MostrarAsistencias.aspx");
        }
    }
}